...
public class Message {
    ...
    public static final String USERNAME_NOT_ACTIVE = "Tài khoản chưa được kích hoạt!";
    public static final String USER_NOT_EXITED = "Người dùng không tồn tại!";
    ...
    public static final String ACCOUNT_ACTIVED = "Tài khoản đã được kích hoạt!";
